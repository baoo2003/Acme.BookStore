...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 14f11757-10ff-41b6-8485-0915c19e8310
```

> `14f11757-10ff-41b6-8485-0915c19e8310` is the password of the certificate, you can change it to any password you want.
